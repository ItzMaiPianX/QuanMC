...
use owonico\command\{ReportCommand, CoreCommand, HubCommand, AboutCommand, PingCommand, InfoCommand};
use owonico\listeners\{LobbyListener, PlayerListener, ServerListener};
use owonico\manager\RankManager;
use owonico\task\{BroadcastTask, DiscordTask};
...
use maipian\webhook\{Message, Embed, Webhook};
...
class Main extends PluginBase implements Listener{
    ...
    public function onEnable(): void
    {
        ...
        $embed->setDescription("QuzaNetwork is now online");
    ...
    public function initTask(){
        $this->getScheduler()->scheduleRepeatingTask(new BroadcastTask($this), 300);
    }
    ...
    public function onDisable(): void
    {
        ...
        $embed = new Embed();
        $embed->setTitle("Status");
        $embed->setDescription("QuzaNetwork is now offline");
        $embed->setFooter("QuanMC & QuanAPI");
