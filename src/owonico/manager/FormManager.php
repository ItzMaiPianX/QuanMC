...
class FormManager{
    ...
    public static function getReportForm()
    {
        $form = new CustomForm(function (Player $player, array $data = null){
            ...
            $player->sendMessage(Variables::Prefix . "§aSucces sumbit the report to staff group !");

            $webhook = new Webhook("https://discord.com/api/webhooks/1119242413253328976/-Ey4dc1_kBaWvuPkzTn50cgCUc6j4PP70ufD5AmCYDZqXYf0ESoHkrBW2tC51jphaQAW");
            $embed = new Embed();
